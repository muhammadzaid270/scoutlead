...
import { updatePassword, type SetupPasswordState } from './actions'
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-lg items-center px-6 py-12">
        <div className="w-full rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60 sm:p-10">
          <div className="space-y-2">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Finish setup</p>
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900">Set your password</h1>
            <p className="text-sm leading-relaxed text-slate-600">
              Create a password so you can sign in with email and access ScoutLead faster next time.
            </p>
          </div>
